...
const almacenaDatos = localStorage.getItem('carrito')
...
const pintarFooter = () => {
    ...
    if (Object.keys(carrito).length === 0) {
        footer.innerHTML = `
        <th scope="row" colspan="5">Carrito vacío - comience a pedir!</th>
        `
        return
    }
...
const boton = document.getElementById('compra-final');
boton.addEventListener('click', () => {
    Swal.fire({
        title: 'Genial',
        text: 'Solo falta el pago.',
